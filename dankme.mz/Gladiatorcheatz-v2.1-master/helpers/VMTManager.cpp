...
uintptr_t* UDVMT::search_free_data_page(const char* module_name, const std::size_t vmt_size) //Modified code from exphck https://www.unknowncheats.me/forum/2128832-post43.html
{
...
bool UDVMT::setup(void * base, const char * moduleName)
{
	if (base != nullptr)
		class_base = base;
...
std::size_t UDVMT::estimate_vftbl_length(std::uintptr_t* vftbl_start)
{
