...
namespace Utils
{
	...
	bool ConsolePrint(bool logToFile, const char *fmt, ...)
	{
		...
		{
			std::ofstream file;
			file.open(std::string("dankme.mz_repasted").append(".log"), std::ios::app);
			file << outRes;
			file.close();
		}
	...
	void RankRevealAll()
	{
		...
		static auto fnServerRankRevealAll = PatternScan(GetModuleHandle("client_panorama.dll"), "55 8B EC 8B 0D ? ? ? ? 85 C9 75 ? A1 ? ? ? ? 68 ? ? ? ? 8B 08 8B 01 FF 50 ? 85 C0 74 ? 8B C8 E8 ? ? ? ? 8B C8 EB ? 33 C9 89 0D ? ? ? ? 8B 45 ? FF 70 ? E8 ? ? ? ? B0 ? 5D");
	...
	void IsReady()
	{
		...
		static uint8_t *fnIsReady = PatternScan(GetModuleHandle("client_panorama.dll"), "55 8B EC 8B 0D ? ? ? ? 85 C9 75 ? A1 ? ? ? ? 68 ? ? ? ? 8B 08 8B 01 FF 50 ? 85 C0 74 ? 8B C8 E8 ? ? ? ? 8B C8 EB ? 33 C9 89 0D ? ? ? ? 8B 45 ? FF 70 ? E8 ? ? ? ? B0 ? 5D");
