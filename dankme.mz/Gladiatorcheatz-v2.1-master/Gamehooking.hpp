...
extern std::unique_ptr<UDVMT> g_pClientStateHook_ud;
extern std::unique_ptr<UDVMT> g_pNetChannelHook_ud;
extern std::unique_ptr<UDVMT> g_pSendDatagramHook_ud;
extern std::unique_ptr<ShadowVTManager> g_pClientStateHook;
extern std::unique_ptr<ShadowVTManager> g_pNetChannelHook;
extern std::unique_ptr<ShadowVTManager> g_pSendDatagramHook;
...
/* bc panorama broke old method */
typedef void(__thiscall* LockCursor)(void*);
extern LockCursor o_LockCursor;
...
/* p fakelatency */
typedef bool(__thiscall *net_showfragments_t)(void*);
extern net_showfragments_t o_ShowFragments;
...
namespace Handlers
{
	...
	void __fastcall DrawModelExecute_h(void* ecx, void* edx, IMatRenderContext* context, const DrawModelState_t& state, const ModelRenderInfo_t& render_info, matrix3x4_t* matrix);
	...
	bool __fastcall ShowFragments_h(void* cvar, void* edx);
