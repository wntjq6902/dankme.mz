...
public:
	...
	void VelocityExtrapolate(C_BasePlayer *player, Vector &origin, Vector &velocity, int &flags, bool was_in_air);
	Vector VelocityExtrapolate(C_BasePlayer* pTarget, int amountOfTicks = 0);
