...
void InitializeKits()
{
	...
	// call    ItemSystem
	// push    uintptr_t ptr [esi+0Ch]
	// lea     ecx, [eax+4]
	// call    CEconItemSchema::GetPaintKitDefinition


	auto sig_address = Utils::PatternScan(GetModuleHandle((Global::bIsPanorama ? "client_panorama.dll" : "client.dll")), "E8 ?? ?? ?? ?? FF 76 0C 8D 48 04 E8");
