...
public:
	...
	int last_incoming_sequence = 0;					//for fakeping
	...
	void AnimationFix2(ClientFrameStage_t stage);
	...
	void LegitBackTrack(CUserCmd *usercmd);

	void UpdateIncomingSequences();
	void AddLatency(INetChannel* net_channel, float latency);
	void AddLatency2(INetChannel* net_channel, float latency);
};